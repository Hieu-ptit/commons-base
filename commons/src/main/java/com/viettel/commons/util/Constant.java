...
public final class Constant {
    ...
    public static final String ADDRESS_TO_ACCOUNT = "ADDRESS_TO_ACCOUNT";
    public static final String ADDRESS_TO_PLAYED_ACCOUNT = "ID_TO_PLAYED_ACCOUNT";
    ...
    public static final long FAIR_GID = 0;
    ...
    public static final String PREFIX_RESPONSE_CODE = "FAIR-";
    public static final String X_GAME_ID = "X-GAME-ID";
    public static final String UPDATED = "UPDATED";
    public static final String UNBOXED = "UNBOXED";
    public static final BigInteger DAY_OF_YEAR = BigInteger.valueOf(365);
    public static final String HERO_SKILL_MAP = "HERO_SKILL_MAP";
    public static final String PAYMENT_ACTION_PREFIX = "payment.";
